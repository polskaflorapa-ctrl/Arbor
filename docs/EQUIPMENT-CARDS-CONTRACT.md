...
- Karty sprzetu pokazuja `data_przegladu`, status, oddzial, ekipe, numer seryjny oraz `koszt_motogodziny`.
...
- Backend: `vehicles.data_przegladu`, `vehicles.data_ubezpieczenia`, `equipment_items.data_przegladu`, `equipment_items.koszt_motogodziny`.
