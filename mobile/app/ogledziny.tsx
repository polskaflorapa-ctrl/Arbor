      ...
      <View style={S.commandPanel}>
        <View style={S.commandHead}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            <Text style={S.commandSub}>Trasa, strefy, telefon i mapa pod ręką.</Text>
          </View>
...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  commandTitle: { color: t.text, fontSize: 15, fontWeight: '900' },
  commandSub: { color: t.textMuted, fontSize: 11, lineHeight: 15, marginTop: 2, fontWeight: '700' },
  commandBadge: {
    minWidth: 56,
    borderWidth: 1,
  ...
  commandStats: { flexDirection: 'row', gap: 6 },
  commandStat: {
    flex: 1,
    minHeight: 62,
    borderWidth: 1,
  ...
  cardTitle: { fontSize: 15, fontWeight: '900', color: t.text, flex: 1, letterSpacing: 0 },
  cardSub: { fontSize: 12, color: t.textSub, fontWeight: '700' },
