            ...
            {mySettlementOverview ? (
              <View style={S.section}>
                ...
                {mySettlementOverview.estimator_month || mySettlementOverview.estimator_stats ? (
                  <View style={{ marginTop: 10, padding: 10, borderRadius: 6, backgroundColor: theme.surface2 }}>
                    <Text style={[S.sectionTitle, { fontSize: 13, marginBottom: 6 }]}>Mój miesiąc (specjalista oględzin)</Text>
...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  msgBox: { padding: 12, margin: 12, borderRadius: 6 },
  msgText: { fontWeight: '600', textAlign: 'center' },
  tabsWrap: { paddingHorizontal: 12, paddingTop: 10, paddingBottom: 4, backgroundColor: t.bg },
  tabs: { flexDirection: 'row', gap: 6, borderWidth: 1, borderColor: t.cardBorder, borderRadius: 7, backgroundColor: t.surface2, padding: 4 },
  ...
  scroll: { flex: 1 },
  section: { backgroundColor: t.cardBg, margin: 12, borderRadius: 7, padding: 14, borderWidth: 1, borderColor: t.cardBorder, elevation: 0 },
  ...
  taskInfo: { backgroundColor: t.surface2, borderRadius: 6, padding: 12, marginBottom: 14 },
  ...
  pomocnikCard: { backgroundColor: t.surface2, borderRadius: 6, padding: 12, marginBottom: 10, borderLeftWidth: 3, borderLeftColor: t.accent },
  pomocnikHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  avatar: { width: 40, height: 40, borderRadius: 7, backgroundColor: t.accentLight, alignItems: 'center', justifyContent: 'center' },
  ...
  input: { borderWidth: 1, borderColor: t.inputBorder, borderRadius: 6, paddingHorizontal: 11, minHeight: 46, fontSize: 14, backgroundColor: t.inputBg, color: t.inputText },
  ...
  saveBtn: { backgroundColor: t.accent, minHeight: 50, borderRadius: 7, alignItems: 'center', justifyContent: 'center', marginTop: 12 },
  ...
  pomocnicyPreview: { backgroundColor: t.surface2, borderRadius: 6, padding: 12, marginBottom: 12 },
  ...
  wynikiBox: { backgroundColor: t.surface2, borderRadius: 7, padding: 16, marginTop: 16 },
  ...
  kpi: { flex: 1, backgroundColor: t.surface2, borderRadius: 6, padding: 12, alignItems: 'center', borderTopWidth: 3 },
  kpiNum: { fontSize: 18, fontWeight: '700', marginBottom: 2 },
  kpiLabel: { fontSize: 11, color: t.textMuted, textAlign: 'center' },
  zarobek: { backgroundColor: t.successBg, borderRadius: 7, padding: 20, alignItems: 'center' },
  ...
  zlecenieCard: { backgroundColor: t.surface2, borderRadius: 6, padding: 12, marginBottom: 10 },
