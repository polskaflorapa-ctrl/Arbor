...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  headerTitle: { color: t.text, fontSize: 18, fontWeight: '900', marginTop: 2 },
  ...
  intakeTitle: { color: t.text, fontSize: 16, fontWeight: '900' },
  ...
  clientQuickActionText: { color: t.accent, fontSize: 12, fontWeight: '900' },
  sprintCard: {
    marginHorizontal: 12,
    marginTop: 10,
    borderWidth: 1,
  ...
  helperText: { color: t.textSub, fontSize: 13, lineHeight: 19, marginBottom: 12 },
