...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  searchInner: {
    ...
    backgroundColor: t.inputBg, borderRadius: 6, paddingHorizontal: 12,
  ...
  kpiIcon: { width: 28, height: 28, borderRadius: 6, alignItems: 'center', justifyContent: 'center' },
  ...
  avatar: { width: 50, height: 50, borderRadius: 7, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  ...
  rolaBadge: { paddingHorizontal: 9, paddingVertical: 5, borderRadius: 5 },
