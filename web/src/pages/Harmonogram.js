...
function gpsStatus(row) {
  ...
  if (age == null) {
    return {
      ...
      bg: 'rgba(154, 144, 122, 0.12)',
      border: 'rgba(154, 144, 122, 0.24)',
    };
  }
  ...
  if (age <= GPS_STALE_MINUTES) {
    return {
      ...
      meta: `${age} min`,
      color: 'var(--warning)',
      bg: 'rgba(189, 112, 30, 0.12)',
      border: 'rgba(189, 112, 30, 0.34)',
    };
  }
  return {
    key: 'offline',
    ...
    meta: `${age} min`,
    color: 'var(--danger)',
    bg: 'rgba(192, 73, 47, 0.12)',
    border: 'rgba(192, 73, 47, 0.34)',
  };
}
...
const styles = {
  ...
  loading: { textAlign: 'center', padding: 60, color: 'var(--text-muted)', border: '1px dashed rgba(69, 107, 31, 0.2)', borderRadius: 8, background: '#ffffff' },
  calendarWrap: { background: '#ffffff', border: '1px solid rgba(69, 107, 31, 0.13)', borderRadius: 8, boxShadow: '0 12px 30px rgba(69, 107, 31, 0.07)', overflow: 'hidden', flex: 1, minHeight: 520 },
  ...
  dispatchApplyPlanBtn: { minHeight: 34, border: '1px solid rgba(69, 107, 31, 0.25)', borderRadius: 8, background: 'var(--accent-gradient)', color: 'var(--on-accent)', fontWeight: 950, fontSize: 12, padding: '7px 12px', cursor: 'pointer' },
  dispatchLoadedRoutes: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: 8 },
  dispatchLoadedRoute: { border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: '#ffffff', padding: '8px 10px', display: 'grid', gap: 3, color: 'var(--text)', fontSize: 12, fontWeight: 850 },
  dispatchLoadedRouteMuted: { border: '1px dashed rgba(69, 107, 31, 0.18)', borderRadius: 8, background: 'rgba(255,255,255,0.7)', padding: '8px 10px', color: 'var(--text-muted)', fontSize: 12, fontWeight: 900 },
  dispatchRadar: { display: 'grid', gridTemplateColumns: 'minmax(220px, 0.9fr) repeat(5, minmax(128px, 1fr))', gap: 8, marginBottom: 12 },
  dispatchRadarLead: { minHeight: 84, borderRadius: 8, padding: '12px 14px', display: 'grid', alignContent: 'center', gap: 3, background: 'linear-gradient(135deg, #456b1f 0%, #456b1f 100%)', color: '#fff', boxShadow: '0 12px 28px rgba(69, 107, 31, 0.16)' },
  dispatchDecisionCard: { minHeight: 84, border: '1px solid rgba(69, 107, 31, 0.13)', borderLeft: '4px solid rgba(69, 107, 31, 0.26)', borderRadius: 8, background: '#ffffff', color: 'var(--text)', padding: '10px 12px', display: 'grid', alignContent: 'center', gap: 2, textAlign: 'left', cursor: 'pointer', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)', fontFamily: 'inherit' },
  dispatchDecisionOk: { borderLeftColor: 'var(--accent)', background: 'linear-gradient(180deg, #ffffff, rgba(127, 140, 18, 0.07))' },
  dispatchDecisionWarn: { borderLeftColor: 'var(--warning)', background: 'linear-gradient(180deg, #ffffff, rgba(189, 112, 30, 0.09))' },
  dispatchDecisionDanger: { borderLeftColor: 'var(--danger)', background: 'linear-gradient(180deg, #ffffff, rgba(192, 73, 47, 0.09))' },
  dispatchKpis: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 8, marginBottom: 12 },
  dispatchKpi: { minHeight: 62, borderWidth: 1, borderStyle: 'solid', borderColor: 'rgba(69, 107, 31, 0.13)', borderRadius: 8, background: '#ffffff', padding: '10px 12px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  dispatchKpiWarn: { borderColor: 'rgba(189, 112, 30, 0.42)', background: 'rgba(189, 112, 30, 0.09)' },
  dispatchKpiDanger: { borderColor: 'rgba(192, 73, 47, 0.46)', background: 'rgba(192, 73, 47, 0.1)' },
  dispatchSlotBoard: { border: '1px solid rgba(69, 107, 31, 0.13)', borderRadius: 8, background: '#ffffff', marginBottom: 12, overflowX: 'auto', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  ...
  dispatchSlotCellDrop: { background: 'rgba(127, 140, 18, 0.12)', boxShadow: 'inset 0 0 0 2px rgba(127, 140, 18, 0.38)' },
  dispatchSlotCellConflict: { background: 'rgba(192, 73, 47, 0.08)' },
  ...
  dispatchTeamCard: { textAlign: 'left', borderWidth: 1, borderStyle: 'solid', borderColor: 'rgba(69, 107, 31, 0.13)', borderRadius: 8, background: '#ffffff', color: 'var(--text)', padding: 12, cursor: 'pointer', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)', minHeight: 126 },
  dispatchTeamCardDrop: { borderColor: 'var(--accent)', boxShadow: '0 0 0 2px rgba(127, 140, 18, 0.22), var(--shadow-md)', transform: 'translateY(-1px)' },
  ...
  dispatchLoadTrack: { height: 7, borderRadius: 999, background: 'rgba(154, 144, 122, 0.18)', overflow: 'hidden', marginBottom: 10 },
  ...
  zlecenieBlockConflict: { boxShadow: '0 0 0 2px rgba(192, 73, 47, 0.38), var(--shadow-md)', borderColor: 'rgba(192, 73, 47, 0.62)' },
