...
const s = {
  ...
  card: { width: '100%', display: 'grid', gridTemplateColumns: '44px minmax(0, 1fr) auto auto', alignItems: 'center', gap: 16, border: '1px solid #f0ebdd', borderRadius: 14, background: '#fff', padding: 18, textAlign: 'left', cursor: 'pointer', boxShadow: '0 1px 2px rgba(15,23,42,0.04)' },
