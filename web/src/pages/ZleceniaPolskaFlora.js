...
const s = {
  ...
  cardMeta: { color: '#6f6555', fontSize: 13 },
  tags: { display: 'flex', flexWrap: 'wrap', gap: 6, color: '#6f6555', fontSize: 11 },
  ...
  empty: { padding: 40, borderRadius: 14, background: '#fff', border: '1px solid #f0ebdd', color: '#6f6555', textAlign: 'center', fontWeight: 800 },
