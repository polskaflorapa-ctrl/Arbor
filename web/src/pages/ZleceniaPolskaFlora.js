...
const s = {
  shell: { display: 'flex', minHeight: '100vh', background: '#f0ebdd' },
  main: { flex: 1, minWidth: 0, marginLeft: 256, padding: '24px', color: '#2c2011' },
  message: { marginBottom: 16 },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, marginBottom: 22 },
  title: { margin: 0, fontSize: 28, fontWeight: 850, color: '#2c2011' },
  subtitle: { margin: '6px 0 0', color: '#8a8069', fontSize: 14 },
  primaryBtn: { border: 0, borderRadius: 12, background: '#456b1f', color: '#fff', padding: '12px 16px', fontWeight: 800, cursor: 'pointer' },
  tabs: { display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  tab: { border: '1px solid #f0ebdd', borderRadius: 10, background: '#fff', color: '#5a5040', padding: '9px 13px', fontSize: 13, fontWeight: 800, cursor: 'pointer' },
  tabActiveDark: { background: '#2c2011', color: '#fff', borderColor: '#2c2011' },
  tabActive: { background: '#e4efd6', color: '#456b1f', borderColor: '#e4efd6' },
  filters: { display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 240px', gap: 12, marginBottom: 18 },
  search: { border: '1px solid #f0ebdd', borderRadius: 12, background: '#fff', padding: '12px 14px', fontSize: 14, outline: 'none' },
  select: { border: '1px solid #f0ebdd', borderRadius: 12, background: '#fff', padding: '12px 14px', fontSize: 14, outline: 'none' },
  list: { display: 'grid', gap: 12 },
  card: { width: '100%', display: 'grid', gridTemplateColumns: '44px minmax(0, 1fr) auto auto', alignItems: 'center', gap: 16, border: '1px solid #f0ebdd', borderRadius: 14, background: '#fff', padding: 18, textAlign: 'left', cursor: 'pointer', boxShadow: '0 1px 2px rgba(44, 32, 17,0.04)' },
  serviceBadge: { width: 38, height: 38, borderRadius: 12, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#f0ebdd', color: '#456b1f', fontWeight: 900 },
  cardBody: { display: 'grid', gap: 6, minWidth: 0 },
  cardTitle: { color: '#2c2011', fontSize: 16, fontWeight: 850 },
  cardMeta: { color: '#8a8069', fontSize: 13 },
  tags: { display: 'flex', flexWrap: 'wrap', gap: 6, color: '#8a8069', fontSize: 11 },
  cardSide: { display: 'grid', gap: 3, justifyItems: 'end', color: '#2c2011' },
  status: { borderRadius: 999, background: '#f0ebdd', color: '#456b1f', padding: '7px 10px', fontSize: 12, fontWeight: 850 },
  empty: { padding: 40, borderRadius: 14, background: '#fff', border: '1px solid #f0ebdd', color: '#9a907a', textAlign: 'center', fontWeight: 800 },
  drawerLayer: { position: 'fixed', inset: 0, zIndex: 800, display: 'flex', justifyContent: 'flex-end' },
  drawerBackdrop: { position: 'absolute', inset: 0, border: 0, background: 'rgba(44, 32, 17,0.42)' },
  drawer: { position: 'relative', width: 'min(520px, 100vw)', height: '100%', background: '#fff', boxShadow: '-24px 0 60px rgba(44, 32, 17,0.2)', overflowY: 'auto' },
  drawerHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 22px', borderBottom: '1px solid #f0ebdd' },
  closeBtn: { border: 0, background: '#f0ebdd', borderRadius: 10, width: 36, height: 36, fontSize: 24, cursor: 'pointer' },
  drawerBody: { padding: 24 },
  serviceBadgeLarge: { width: 58, height: 58, borderRadius: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#f0ebdd', color: '#456b1f', fontWeight: 900, fontSize: 20 },
  detailGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '22px 0' },
  primaryWide: { width: '100%', border: 0, borderRadius: 12, background: '#456b1f', color: '#fff', padding: 13, fontWeight: 900, cursor: 'pointer' },
};
