                ...
                {(advisor.recommendations || []).map((item, idx) => (
                  <div key={`${item.title || 'recommendation'}-${idx}`} style={s.recommendation}>
                    <div style={s.recommendationTop}>
                      <span style={{ ...s.priority, background: PRIORITY_COLOR[item.priority] || '#8a8069' }}>
                        {item.priority || 'info'}
                      </span>
...
const s = {
  ...
  backBtn:  { padding: '8px 14px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.28)', background: '#ffffff', color: '#456b1f', cursor: 'pointer', fontSize: 13, fontWeight: 900, boxShadow: '0 14px 28px rgba(0,0,0,0.12)' },
  controls: {
    display: 'flex',
    gap: 16,
    alignItems: 'flex-end',
  ...
  previewBtn:{ padding: '10px 18px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.16)', background: '#ffffff', color: 'var(--text)', cursor: 'pointer', fontSize: 14, fontWeight: 800 },
  aiBtn:    { padding: '10px 18px', borderRadius: 8, border: '1px solid #766440', background: '#f0ebdd', color: '#766440', cursor: 'pointer', fontSize: 14, fontWeight: 700 },
  saveBtn:  { padding: '10px 18px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.22)', background: 'var(--accent-gradient)', color: 'var(--on-accent)', cursor: 'pointer', fontSize: 14, fontWeight: 700 },
  applyBtn: { padding: '10px 18px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.22)', background: 'var(--accent-gradient)', color: 'var(--on-accent)', cursor: 'pointer', fontSize: 14, fontWeight: 700 },
  workflowStrip:{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: 8, margin: '0 0 14px', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.13)', background: '#ffffff', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  workflowStep:{ display: 'flex', alignItems: 'center', gap: 9, minWidth: 0, padding: '7px 8px', borderRadius: 7, border: '1px solid transparent' },
  workflowStepDone:{ background: '#f0ebdd', borderColor: '#e4efd6' },
  workflowStepActive:{ background: '#f0ebdd', borderColor: '#f1f3d6' },
  ...
  preflightFixBtn:{ flexShrink: 0, padding: '8px 12px', borderRadius: 7, border: '1px solid #7f8c12', background: '#f0ebdd', color: '#456b1f', cursor: 'pointer', fontSize: 12, fontWeight: 900 },
  preflightBypassBtn:{ flexShrink: 0, padding: '8px 12px', borderRadius: 7, border: '1px solid #c0492f', background: '#fff', color: '#a3402a', cursor: 'pointer', fontSize: 12, fontWeight: 800 },
  advisorPanel:{ marginBottom: 18, padding: '16px 18px', background: '#ffffff', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.13)', boxShadow: '0 12px 30px rgba(69, 107, 31, 0.07)' },
  advisorHeader:{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 14, marginBottom: 14 },
  advisorEyebrow:{ fontSize: 11, fontWeight: 800, color: '#766440', textTransform: 'uppercase', letterSpacing: 0 },
  ...
  copyBriefBtn:{ padding: '6px 9px', borderRadius: 7, border: '1px solid #766440', background: '#fff', color: '#766440', cursor: 'pointer', fontSize: 11, fontWeight: 800 },
  ...
  manualBrief:{ width: '100%', minHeight: 130, boxSizing: 'border-box', resize: 'vertical', padding: 10, borderRadius: 8, border: '1px solid #c0492f', background: '#f0ebdd', color: '#a3402a', fontSize: 12, lineHeight: 1.45, marginBottom: 14, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace' },
  ...
  dispatchGateBad:{ borderColor: '#f6e0d9', background: '#f0ebdd' },
  dispatchGateWarn:{ borderColor: '#fae7d2', background: '#f0ebdd' },
  dispatchGateReady:{ borderColor: '#e4efd6', background: '#f0ebdd' },
  ...
  riskFilterBtnActive:{ border: '1px solid #766440', background: '#f0ebdd', color: '#766440' },
  ...
  issueChipCritical:{ background: '#f0ebdd', color: '#a3402a' },
  issueChipWarn:{ background: '#f0ebdd', color: '#a3402a' },
  issueChipActive:{ border: '1px solid #766440', background: '#f0ebdd', color: '#766440' },
  ...
  riskBadgeCritical:{ flexShrink: 0, borderRadius: 999, padding: '2px 7px', background: '#f6e0d9', color: '#a3402a', fontSize: 10, fontWeight: 900 },
  riskBadgeWarn:{ flexShrink: 0, borderRadius: 999, padding: '2px 7px', background: '#fae7d2', color: '#995510', fontSize: 10, fontWeight: 900 },
  riskTaskActions:{ marginLeft: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 6, flexWrap: 'wrap' },
  openTaskCta:{ padding: '4px 7px', borderRadius: 7, border: '1px solid var(--border)', background: '#fff', color: '#766440', cursor: 'pointer', fontSize: 11, fontWeight: 800 },
  repairTaskBtn:{ padding: '4px 7px', borderRadius: 7, border: '1px solid #7f8c12', background: '#f0ebdd', color: '#456b1f', cursor: 'pointer', fontSize: 11, fontWeight: 900 },
  qualityPill:{ flexShrink: 0, minWidth: 40, textAlign: 'center', borderRadius: 6, padding: '2px 6px', background: '#f0ebdd', color: '#5a5040', fontSize: 11, fontWeight: 800 },
  statsBar: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12, marginBottom: 18 },
  statCard: { flex: 1, minWidth: 100, padding: '12px 16px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.13)', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  statValue:{ fontSize: 22, fontWeight: 800 },
  statLabel:{ fontSize: 11, fontWeight: 600, color: 'var(--text-sub)', textTransform: 'uppercase', marginTop: 4 },
  availabilityPanel:{ marginBottom: 18, padding: '13px 14px', borderRadius: 8, border: '1px solid #e4efd6', background: '#f0ebdd', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  availabilityPanelWarn:{ borderColor: '#fae7d2', background: '#f0ebdd' },
  ...
  availabilityCounter:{ flexShrink: 0, padding: '5px 9px', borderRadius: 8, border: '1px solid #e4efd6', background: '#fff', color: '#456b1f', fontSize: 12, fontWeight: 900 },
  availabilityCounterWarn:{ borderColor: '#fae7d2', color: '#a3402a' },
  ...
  absentTeamItem:{ display: 'grid', gap: 3, padding: '9px 10px', borderRadius: 8, border: '1px solid #fae7d2', background: '#fff', color: '#a3402a', fontSize: 12 },
  competencyBlock:{ marginBottom: 18, padding: '12px 14px', borderRadius: 8, border: '1px solid #f6e0d9', background: '#f0ebdd', color: '#a3402a', display: 'grid', gap: 4, boxShadow: '0 10px 24px rgba(163, 64, 42, 0.06)' },
  ...
  handoffPanel:{ marginBottom: 18, padding: '13px 14px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.13)', background: '#ffffff', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  handoffPanelReady:{ borderColor: '#e4efd6', background: '#f0ebdd' },
  ...
  handoffStatusMeta:{ color: '#456b1f', fontSize: 11, fontWeight: 850 },
  handoffStatusError:{ color: '#a3402a', fontSize: 11, fontWeight: 850 },
  ...
  routeCard:{ background: '#ffffff', borderRadius: 8, overflow: 'hidden', border: '1px solid rgba(69, 107, 31, 0.13)', boxShadow: '0 12px 30px rgba(69, 107, 31, 0.07)' },
  ...
  routeBriefStatus:{ border: '1px solid #fae7d2', background: '#f0ebdd', color: '#a3402a', borderRadius: 8, padding: '6px 8px', fontSize: 11, fontWeight: 900, lineHeight: 1.2 },
  routeBriefStatusDone:{ borderColor: '#e4efd6', background: '#f0ebdd', color: '#456b1f' },
  ...
  routeSendBtn:{ border: '1px solid #7f8c12', background: '#f0ebdd', color: '#456b1f' },
  ...
  stopWarningPill:{ borderRadius: 8, padding: '2px 7px', background: '#f0ebdd', color: '#a3402a', border: '1px solid #f6e0d9', fontSize: 10, fontWeight: 900 },
  lateBadge:{ fontSize: 10, background: '#f6e0d9', color: '#c0492f', borderRadius: 4, padding: '1px 5px', fontWeight: 700 },
  ...
  unassignedCard:{ padding: '12px 14px', borderRadius: 8, background: 'var(--surface-field)', border: '1px solid #f6e0d9' },
