...
const s = {
  ...
  availabilityPanel:{ marginBottom: 18, padding: '13px 14px', borderRadius: 8, border: '1px solid #e4efd6', background: '#f0ebdd', boxShadow: '0 10px 24px rgba(31,79,50,0.055)' },
  ...
  competencyBlock:{ marginBottom: 18, padding: '12px 14px', borderRadius: 8, border: '1px solid #f6e0d9', background: '#f0ebdd', color: '#a3402a', display: 'grid', gap: 4, boxShadow: '0 10px 24px rgba(127,29,29,0.06)' },
