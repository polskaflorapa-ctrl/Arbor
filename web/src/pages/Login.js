...
const s = {
  ...
  commandLogoIcon: {
    ...
    boxShadow: '0 22px 48px rgba(127, 140, 18, 0.26)',
  },
  commandKicker: {
    color: '#e4efd6',
    fontSize: 12,
  ...
  featureIcon: {
    ...
    flex: '0 0 auto',
    fontSize: 17,
    background: 'rgba(127, 140, 18, 0.22)',
    boxShadow: 'inset 0 0 0 1px rgba(127, 140, 18, 0.18)',
  },
  commandMap: {
    position: 'absolute',
    right: -40,
    ...
    height: 240,
    borderRadius: 18,
    border: '1px solid rgba(228, 239, 214, 0.2)',
    background: 'linear-gradient(90deg, rgba(228, 239, 214, 0.13) 1px, transparent 1px), linear-gradient(0deg, rgba(228, 239, 214, 0.1) 1px, transparent 1px), rgba(3,7,18,0.28)',
  ...
  mapPin: {
    ...
    borderRadius: '50%',
    background: '#e4efd6',
    boxShadow: '0 0 0 8px rgba(228, 239, 214, 0.16), 0 0 26px rgba(228, 239, 214, 0.7)',
  },
  mapRoute: {
    position: 'absolute',
    left: '22%',
    ...
    width: '56%',
    height: '36%',
    borderTop: '2px dashed rgba(241, 243, 214, 0.72)',
    borderRight: '2px dashed rgba(241, 243, 214, 0.72)',
    borderRadius: 14,
  },
  card: {
    alignSelf: 'center',
  ...
  errBox: {
    display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(192, 73, 47, 0.1)',
    border: '1px solid rgba(192, 73, 47, 0.25)', borderRadius: 10, padding: '10px 14px',
  },
