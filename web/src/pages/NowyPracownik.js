...
const styles = {
  ...
  backBtn: { padding: '8px 16px', backgroundColor: 'var(--surface-field)', color: 'var(--accent-text)', border: '1px solid var(--border)', borderRadius: 8, cursor: 'pointer', fontWeight: 600 },
  title: { fontSize: 24, fontWeight: 'bold', color: 'var(--accent-text)', margin: 0 },
  ...
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: 'var(--accent-text)', marginBottom: 16, paddingBottom: 8, borderBottom: '1px solid var(--border)' },
