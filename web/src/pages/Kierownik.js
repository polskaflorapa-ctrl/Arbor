...
const styles = {
  ...
  cockpitPanel: {
    ...
    borderRadius: 8,
    boxShadow: '0 14px 34px rgba(69, 107, 31, 0.075)',
  },
  ...
  cockpitDate: { minHeight: 36, padding: '7px 10px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.16)', background: '#ffffff', color: 'var(--text)', fontSize: 13 },
  cockpitRefresh: {
    minHeight: 36,
    display: 'inline-flex',
    alignItems: 'center',
  ...
  cockpitError: { marginBottom: 12, padding: '10px 12px', borderRadius: 8, background: 'rgba(192, 73, 47, 0.12)', color: 'var(--danger)', border: '1px solid rgba(192, 73, 47, 0.22)', fontSize: 13 },
  cockpitMetrics: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 10, marginBottom: 14 },
  cockpitMetric: { minHeight: 82, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 4, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, padding: '10px 12px', background: '#ffffff', boxShadow: '0 8px 20px rgba(69, 107, 31, 0.045)' },
  ...
  marginRiskPct: { justifySelf: 'end', border: '1px solid rgba(192, 73, 47, 0.24)', borderRadius: 8, padding: '4px 7px', color: 'var(--danger)', background: 'rgba(192, 73, 47, 0.1)', fontSize: 11, fontWeight: 900, whiteSpace: 'nowrap' },
  ...
  dispatchPlanRow: { display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', padding: 10, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: '#ffffff', boxShadow: '0 8px 20px rgba(69, 107, 31, 0.045)' },
  ...
  recommendationCard: { minWidth: 0, display: 'grid', gap: 8, padding: 10, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: '#ffffff', boxShadow: '0 8px 20px rgba(69, 107, 31, 0.045)' },
  ...
  recommendationAccepted: { justifySelf: 'start', padding: '2px 6px', borderRadius: 7, background: 'rgba(127, 140, 18, 0.12)', color: 'var(--success)', border: '1px solid rgba(127, 140, 18, 0.24)', fontSize: 10, fontStyle: 'normal', fontWeight: 850 },
  recommendationActionText: { color: 'var(--text-sub)', fontSize: 12, lineHeight: 1.35 },
  recommendationPreview: { display: 'grid', gap: 4, padding: '7px 8px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.11)', background: 'rgba(241,249,244,0.68)' },
  ...
  cockpitColumn: { minWidth: 0, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: '#ffffff', padding: 12, boxShadow: '0 8px 20px rgba(69, 107, 31, 0.045)' },
  ...
  oddzialCard: { background: '#ffffff', border: '1px solid rgba(69, 107, 31, 0.13)', borderRadius: 8, padding: '12px 16px', cursor: 'pointer', boxShadow: '0 10px 24px rgba(69, 107, 31, 0.06)', minWidth: 140, transition: 'all 0.2s' },
  ...
  filtryRow: { display: 'flex', gap: 12, marginBottom: 20, alignItems: 'center', flexWrap: 'wrap', background: 'linear-gradient(90deg, rgba(69, 107, 31, 0.04) 1px, transparent 1px), linear-gradient(0deg, rgba(69, 107, 31, 0.035) 1px, transparent 1px), linear-gradient(135deg, rgba(255,255,255,0.98), rgba(241,249,244,0.94))', backgroundSize: '32px 32px, 32px 32px, auto', border: '1px solid rgba(69, 107, 31, 0.13)', padding: '12px 16px', borderRadius: 8, boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
