...
const s = {
  ...
  badge: { border: '1px solid rgba(69, 107, 31, 0.14)', borderRadius: 999, padding: '5px 10px', fontSize: 12, color: 'var(--accent)', background: 'var(--accent-surface)', fontWeight: 800, whiteSpace: 'nowrap' },
