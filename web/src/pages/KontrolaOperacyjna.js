...
const s = {
  ...
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: 7, border: '1px solid rgba(69, 107, 31, 0.24)', background: 'var(--accent-gradient)', color: 'var(--on-accent)', borderRadius: 8, padding: '9px 13px', fontWeight: 850, cursor: 'pointer', boxShadow: '0 8px 18px rgba(69, 107, 31, 0.16)' },
  secondaryBtn: { display: 'inline-flex', alignItems: 'center', gap: 7, border: '1px solid rgba(69, 107, 31, 0.16)', background: '#ffffff', color: 'var(--text)', borderRadius: 8, padding: '9px 13px', fontWeight: 800, cursor: 'pointer' },
  iconBtn: { width: 40, height: 40, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(69, 107, 31, 0.16)', background: '#ffffff', color: 'var(--text)', borderRadius: 8, cursor: 'pointer' },
  filters: { display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'end', marginBottom: 18, padding: 16, border: '1px solid rgba(69, 107, 31, 0.13)', background: 'linear-gradient(90deg, rgba(69, 107, 31, 0.04) 1px, transparent 1px), linear-gradient(0deg, rgba(69, 107, 31, 0.035) 1px, transparent 1px), linear-gradient(135deg, rgba(255,255,255,0.98), rgba(241,249,244,0.94))', backgroundSize: '32px 32px, 32px 32px, auto', borderRadius: 8, boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  ...
  input: { minHeight: 40, border: '1px solid rgba(69, 107, 31, 0.16)', borderRadius: 8, background: '#ffffff', color: 'var(--text)', padding: '0 10px', fontSize: 14 },
  kpis: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 12, marginBottom: 18 },
  kpi: { border: '1px solid rgba(69, 107, 31, 0.13)', background: '#ffffff', borderRadius: 8, padding: 15, boxShadow: '0 10px 24px rgba(69, 107, 31, 0.055)' },
  ...
  digestPanel: { border: '1px solid rgba(69, 107, 31, 0.13)', background: '#ffffff', borderRadius: 8, overflow: 'hidden', marginBottom: 18, boxShadow: '0 12px 30px rgba(69, 107, 31, 0.065)' },
  digestGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 10, padding: 16, borderBottom: '1px solid rgba(69, 107, 31, 0.1)' },
  digestMetric: { border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, padding: 12, background: 'rgba(241,249,244,0.68)' },
  digestList: { display: 'grid', gap: 8, padding: 16 },
  digestAlert: { display: 'grid', gap: 4, padding: 12, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: 'rgba(241,249,244,0.58)' },
  ownerAlertSummary: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 10, padding: 16, borderBottom: '1px solid rgba(69, 107, 31, 0.1)' },
  ...
  runItem: { display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center', padding: 12, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: 'rgba(241,249,244,0.5)' },
  ...
  ownerAckItem: { display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center', padding: 12, border: '1px solid rgba(69, 107, 31, 0.12)', borderRadius: 8, background: 'rgba(241,249,244,0.5)' },
  ...
  panel: { border: '1px solid rgba(69, 107, 31, 0.13)', background: '#ffffff', borderRadius: 8, overflow: 'hidden', boxShadow: '0 12px 30px rgba(69, 107, 31, 0.065)' },
  panelHeader: { display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'flex-start', padding: 18, borderBottom: '1px solid rgba(69, 107, 31, 0.1)' },
  ...
  badge: { border: '1px solid rgba(69, 107, 31, 0.14)', borderRadius: 999, padding: '5px 10px', fontSize: 12, color: 'var(--accent-text)', background: 'var(--accent-surface)', fontWeight: 800, whiteSpace: 'nowrap' },
  tableWrap: { overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse', minWidth: 860 },
  th: { textAlign: 'left', padding: '11px 14px', fontSize: 12, color: 'var(--text-sub)', textTransform: 'uppercase', borderBottom: '1px solid rgba(69, 107, 31, 0.1)', background: 'rgba(241,249,244,0.76)' },
  tr: { borderBottom: '1px solid rgba(69, 107, 31, 0.09)' },
  td: { padding: '13px 14px', verticalAlign: 'top', color: 'var(--text)', fontSize: 14 },
  subLine: { marginTop: 3, color: 'var(--text-sub)', fontSize: 12 },
  link: { color: 'var(--accent-text)', fontWeight: 700, textDecoration: 'none' },
