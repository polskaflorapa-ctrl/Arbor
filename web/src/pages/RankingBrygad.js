...
const S = {
  ...
  winnerIcon: { width: 40, height: 40, borderRadius: 8, background: 'rgba(160, 175, 20, 0.12)', color: 'var(--accent-text)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '1px solid var(--border)' },
  ...
  delegationText: { color: '#9a5613', fontWeight: 800 },
  summaryBar: {
    display: 'grid',
