...
const s = {
  ...
  approveBtn: { padding: '4px 10px', borderRadius: 6, border: 'none', background: '#e4efd6', color: 'var(--accent-text)', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
  rejectBtn:  { padding: '4px 10px', borderRadius: 6, border: 'none', background: '#f6e0d9', color: '#c0492f', cursor: 'pointer', fontWeight: 700, fontSize: 13 },
  ...
  hcTotal:    { fontSize: 13, fontWeight: 700, color: 'var(--accent-text)' },
...
const m = {
  ...
  err:       { margin: '12px 20px 0', padding: '10px 14px', borderRadius: 8, background: '#f6e0d9', color: '#c0492f', fontSize: 13 },
