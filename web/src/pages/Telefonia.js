...
const s = {
  ...
  branchStatusKpiActive: {
    ...
    background: 'rgba(127, 140, 18, 0.10)',
    boxShadow: '0 0 0 2px rgba(69, 107, 31, 0.08)',
  },
  branchFilterNotice: {
    display: 'flex',
    flexWrap: 'wrap',
  ...
  branchRolloutBar: {
    ...
    marginTop: 8,
    borderRadius: 999,
    background: 'rgba(69, 107, 31, 0.10)',
    overflow: 'hidden',
  },
  branchRolloutFill: {
    height: '100%',
  ...
  branchBlockers: {
    ...
    padding: 7,
    borderRadius: 8,
    background: 'rgba(189, 112, 30, 0.10)',
    color: '#a3402a',
    fontSize: 11,
    lineHeight: 1.35,
  },
  ...
  branchQuickStartStep: {
    ...
    padding: 9,
    borderRadius: 8,
    border: '1px solid rgba(69, 107, 31, 0.10)',
    background: '#ffffff',
  },
  ...
  providerReadyNote: {
    ...
    padding: 8,
    borderRadius: 8,
    border: '1px solid rgba(127, 140, 18, 0.30)',
    background: 'rgba(127, 140, 18, 0.10)',
    color: '#456b1f',
    fontSize: 12,
    lineHeight: 1.4,
