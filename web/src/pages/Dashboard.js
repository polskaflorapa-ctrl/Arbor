...
const d = {
  ...
  heroStat: { background: 'rgba(255,255,255,0.95)', border: '1px solid rgba(255,255,255,0.28)', borderRadius: 8, padding: 12, display: 'grid', gap: 3, minWidth: 0, boxShadow: '0 12px 28px rgba(0,0,0,0.12)' },
