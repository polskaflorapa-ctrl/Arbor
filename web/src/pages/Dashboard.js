...
const d = {
  root: {
    ...
    minHeight: '100vh',
    background:
      'radial-gradient(circle at 18% 8%, rgba(127, 140, 18, 0.14), transparent 28%), radial-gradient(circle at 78% 4%, rgba(118, 100, 64, 0.12), transparent 24%), linear-gradient(90deg, rgba(15,23,42,0.045) 1px, transparent 1px), linear-gradient(0deg, rgba(15,23,42,0.04) 1px, transparent 1px), linear-gradient(135deg, #f0ebdd 0%, #f0ebdd 44%, #f0ebdd 100%)',
