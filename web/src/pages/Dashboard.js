...
export default function Dashboard() {
  ...
  const quickLinks = useMemo(() => [
    { label: 'Ranking brygad', sub: 'Liderzy tygodnia i miesiaca', path: '/ranking-brygad', color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik'] },
    { label: 'Nowe zlecenie',  sub: 'Utwórz zlecenie',       path: '/nowe-zlecenie', color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik'] },
    { label: 'Planowanie',     sub: 'Przypisz ekipy',         path: '/kierownik',     color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik'] },
    { label: 'Ekipy',          sub: 'Zarządzaj ekipami',      path: '/ekipy',         color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik'] },
    { label: 'Raporty',        sub: 'Analiza wydajności',     path: '/raporty',           color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik','Brygadzista','Specjalista','Pomocnik','Pomocnik bez doświadczenia'] },
    ...
    { label: 'Raport dzienny', sub: 'Pole — zlecenia, czasy, materiały', path: '/raport-dzienny', color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik','Brygadzista','Specjalista','Pomocnik','Pomocnik bez doświadczenia'] },
    ...
    { label: 'Flota i sprzęt', sub: 'Pojazdy i narzędzia',   path: '/flota',             color: '#9a5613', roles: ['Dyrektor','Administrator','Kierownik','Brygadzista','Magazynier'] },
    { label: 'Magazyn',        sub: 'Stan lokalny (jak w aplikacji mobilnej)', path: '/magazyn', color: 'var(--accent-text)', roles: ['Dyrektor','Administrator','Kierownik','Brygadzista','Magazynier'] },
    ...
    { label: 'Centrum specjalisty ds. wyceny', sub: 'KPI oględzin i skróty (jak w mobile)', path: '/wyceniajacy-hub', color: 'var(--accent-text)', roles: ['Wyceniający','Specjalista','Kierownik','Dyrektor','Administrator'] },
    { label: 'Wyceny',         sub: 'Kalendarz, oględziny, zatwierdzanie', path: '/wycena-kalendarz',  color: 'var(--accent-text)', roles: ['Wyceniający','Specjalista','Kierownik','Dyrektor','Administrator'] },
    ...
    { label: 'Zatwierdzanie wycen', sub: 'Akceptacja i odrzucenie', path: '/zatwierdz-wyceny', color: 'var(--accent-text)', roles: ['Kierownik','Administrator','Dyrektor','Specjalista'] },
    { label: 'Rozliczenie wyceny', sub: 'Stawka + % realizacji', path: '/wynagrodzenie-wyceniajacych', color: 'var(--accent-text)', roles: ['Wyceniający','Kierownik','Dyrektor','Administrator'] },
    ...
    { label: 'Role',           sub: 'Uprawnienia pracowników',path: '/zarzadzaj-rolami',  color: '#9a5613', roles: ['Dyrektor','Administrator'] },
    { label: 'Księgowość',     sub: 'Faktury i rozliczenia',  path: '/ksiegowosc',        color: '#9a5613', roles: ['Dyrektor','Administrator','Kierownik'] },
...
const d = {
  root: {
    ...
    minHeight: '100vh',
    background:
      'radial-gradient(circle at 18% 8%, rgba(127, 140, 18, 0.14), transparent 28%), radial-gradient(circle at 78% 4%, rgba(118, 100, 64, 0.12), transparent 24%), linear-gradient(90deg, rgba(44, 32, 17,0.045) 1px, transparent 1px), linear-gradient(0deg, rgba(44, 32, 17,0.04) 1px, transparent 1px), linear-gradient(135deg, #f0ebdd 0%, #f0ebdd 44%, #f0ebdd 100%)',
  ...
  topbar: {
    ...
    backgroundSize: 'auto',
    boxShadow: '0 18px 44px rgba(44, 32, 17,0.08)',
  },
  ...
  weatherBox: { display: 'flex', flexDirection: 'column', gap: 1, color: 'var(--text)', fontSize: 12, fontWeight: 850, border: '1px solid rgba(69, 107, 31, 0.13)', borderRadius: 8, padding: '7px 10px', background: '#ffffff' },
  dateBox: { display: 'flex', flexDirection: 'column', gap: 1, color: 'var(--text)', fontSize: 12, fontWeight: 850, border: '1px solid rgba(69, 107, 31, 0.13)', borderRadius: 8, padding: '7px 10px', background: '#ffffff' },
  kpiGridLegacy: {
    display: 'grid',
  ...
  kpiCard_green: { borderLeftColor: 'var(--accent-text)' },
  kpiCard_lime:  { borderLeftColor: 'var(--accent-text)' },
  kpiCard_blue:  { borderLeftColor: '#f1f3d6' },
  kpiCard_amber: { borderLeftColor: '#9a5613' },
  ...
  panelWide: {
    border: '1px solid rgba(44, 32, 17,0.09)',
    borderRadius: 22,
    background: 'rgba(255,255,255,0.92)',
    boxShadow: '0 24px 70px rgba(44, 32, 17,0.1)',
    overflow: 'hidden',
  },
  panelHeaderLegacy: {
    display: 'flex',
  ...
  placeBadge_2: { color: '#9a5613', border: '1px solid #9a5613' },
  teamLeaf: {
    width: 28,
    height: 28,
    borderRadius: '50%',
  ...
  scheduleArrow: { color: '#6f6555', display: 'inline-flex', justifyContent: 'flex-end' },
  ...
  alertIcon_warning: { background: '#9a5613' },
  ...
  hero: {
    ...
    background:
      'linear-gradient(90deg, rgba(154, 144, 122, 0.14) 1px, transparent 1px), linear-gradient(0deg, rgba(154, 144, 122, 0.1) 1px, transparent 1px), radial-gradient(circle at 78% 20%, rgba(160, 175, 20, 0.28), transparent 30%), radial-gradient(circle at 12% 18%, rgba(118, 100, 64, 0.22), transparent 28%), linear-gradient(135deg, #2c2011 0%, #5d6a0b 50%, #5d6a0b 100%)',
    backgroundSize: '54px 54px, 54px 54px, auto, auto, auto',
    border: '1px solid rgba(226,232,240,0.18)', overflow: 'hidden',
    boxShadow: '0 34px 90px rgba(44, 32, 17,0.2)',
  },
  heroCompact: {
  ...
  decisionCard: {
    ...
    borderRadius: 20,
    boxShadow: '0 20px 54px rgba(44, 32, 17,0.09)',
    color: 'var(--text)',
    textAlign: 'left',
    cursor: 'pointer',
    fontFamily: 'inherit',
  },
  decisionCard_good: { borderLeftColor: 'var(--accent-text)' },
  decisionCard_warning: { borderLeftColor: '#9a5613', background: 'rgba(255,251,235,0.9)' },
  ...
  panelHeader: {
    ...
    borderBottom: '1px solid rgba(69, 107, 31, 0.1)',
  },
  ...
  tableHead: {
    ...
    borderBottom: '1px solid rgba(69, 107, 31, 0.1)',
    background: 'rgba(69, 107, 31, 0.045)',
    cursor: 'default',
  },
  ...
  rankPlaceLead: { color: '#9a5613', borderColor: 'rgba(189, 112, 30, 0.5)', background: 'rgba(189, 112, 30, 0.12)' },
  rankLeaf: { color: 'var(--accent-text)', display: 'grid', placeItems: 'center' },
