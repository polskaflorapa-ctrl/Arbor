...
const d = {
  ...
  heroEyebrow: { color: '#a7f3c7', fontSize: 11, fontWeight: 950, textTransform: 'uppercase', letterSpacing: 0, marginBottom: 6 },
  ...
  panelTitle: { fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 900, color: '#12251a', textTransform: 'none', letterSpacing: 0 },
