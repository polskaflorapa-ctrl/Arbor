                ...
                <button key={card.team.id} type="button" style={ui.card} onClick={() => setSelectedTeam(card.team)}>
                  ...
                  <div style={ui.stats}>
                    ...
                    <div style={{ ...ui.stat, background: '#f0ebdd' }}>
                      <strong style={{ color: '#766440' }}>{card.activeTasks}</strong>
                      <span style={{ color: '#766440' }}>Aktywne</span>
                    </div>
                    <div style={{ ...ui.stat, background: '#f0ebdd' }}>
...
const ui = {
  ...
  card: { position: 'relative', textAlign: 'left', border: '1px solid #f0ebdd', background: '#fff', borderRadius: 12, padding: 20, cursor: 'pointer', boxShadow: '0 8px 24px rgba(15, 23, 42, 0.04)' },
  ...
  infoPanel: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, borderRadius: 12, background: '#f0ebdd', padding: 16, color: '#456b1f' },
  kicker: { margin: '0 0 4px', fontSize: 12, color: '#456b1f' },
  sectionTitle: { margin: '0 0 12px', display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#5a5040' },
