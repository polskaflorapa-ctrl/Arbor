...
const ui = {
  ...
  card: { position: 'relative', textAlign: 'left', border: '1px solid #f0ebdd', background: '#fff', borderRadius: 12, padding: 20, cursor: 'pointer', boxShadow: '0 8px 24px rgba(44, 32, 17, 0.04)' },
