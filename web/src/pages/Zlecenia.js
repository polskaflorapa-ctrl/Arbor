                      ...
                      <div key={z.id} className="zlecenia-data-card" style={s.listTaskCard} onClick={() => otworzSzczegoly(z)}>
                        <div style={s.listTaskTop}>
                          ...
                          <div style={s.akcjeRow} onClick={(e) => e.stopPropagation()}>
                            ...
                            {mozeUsuwac && (
                              <button type="button" style={{ ...s.btnSm, backgroundColor: 'rgba(192, 73, 47, 0.1)', color: '#c0492f' }} onClick={() => setPotwierdzUsuniecie(z)} title={t('common.delete')} aria-label={t('common.delete')}>
                        ...
                        {items.length === 0 ? (
                          ...
                          <div
                            ...
                            <div style={s.kanbanActions} onClick={(e) => e.stopPropagation()}>
                              ...
                              {mozeUsuwac && (
                                <button
                                  style={{ ...s.kanbanActionBtn, color: '#c0492f', backgroundColor: 'rgba(192, 73, 47, 0.12)' }}
              ...
              actions={
                <>
                  ...
                  {mozeUsuwac && (
                    <button
                      type="button"
                      style={{ ...s.btnSecondary, backgroundColor: 'rgba(192, 73, 47, 0.1)', color: '#c0492f', border: '1px solid #f6e0d9' }}
...
const s = {
  ...
  filtryRow: {
    ...
    background:
      'linear-gradient(90deg, rgba(69, 107, 31, 0.04) 1px, transparent 1px), linear-gradient(0deg, rgba(69, 107, 31, 0.035) 1px, transparent 1px), linear-gradient(135deg, rgba(255,255,255,0.98), rgba(241,249,244,0.94))',
    backgroundSize: '32px 32px, 32px 32px, auto',
    padding: '13px 14px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.14)',
    boxShadow: '0 12px 30px rgba(69, 107, 31, 0.07)', flexWrap: 'wrap'
  },
  ...
  z2Cockpit: {
    ...
    padding: 16,
    marginBottom: 14,
    border: '1px solid rgba(241, 243, 214, 0.22)',
    borderRadius: 8,
    background:
      'radial-gradient(circle at 10% 0%, rgba(127, 140, 18, 0.22), transparent 34%), radial-gradient(circle at 92% 12%, rgba(118, 100, 64, 0.14), transparent 30%), linear-gradient(135deg, #5d6a0b 0%, #5d6a0b 48%, #2c2011 100%)',
    color: '#f0ebdd',
  ...
  z2Primary: {
    ...
    gap: 14,
    padding: 14,
    border: '1px solid rgba(154, 144, 122, 0.18)',
    borderRadius: 8,
  ...
  z2HealthPill: {
    ...
    borderRadius: 8,
    padding: '4px 9px',
    border: '1px solid rgba(154, 144, 122, 0.22)',
    fontSize: 11,
    fontWeight: 950,
  },
  z2HealthPillGood: { color: '#e4efd6', background: 'rgba(127, 140, 18, 0.12)', borderColor: 'rgba(228, 239, 214, 0.24)' },
  z2HealthPillWarning: { color: '#fae7d2', background: 'rgba(189, 112, 30, 0.12)', borderColor: 'rgba(250, 231, 210, 0.28)' },
  ...
  z2ProgressTrack: { height: 10, borderRadius: 999, overflow: 'hidden', background: 'rgba(154, 144, 122, 0.18)' },
  ...
  z2FlowStepActive: { borderColor: 'rgba(241, 243, 214, 0.58)', background: 'rgba(118, 100, 64, 0.14)', color: '#ffffff' },
  ...
  z2PrimaryBtn: {
    ...
    fontWeight: 950,
    fontFamily: 'inherit',
    boxShadow: '0 16px 34px rgba(127, 140, 18, 0.24)',
  },
  z2GhostBtn: {
    border: '1px solid rgba(241, 243, 214, 0.26)',
    borderRadius: 8,
    background: 'rgba(15,23,42,0.58)',
    color: '#e4efd6',
    minHeight: 42,
  ...
  z2QueueRank: { width: 30, height: 30, borderRadius: 8, display: 'grid', placeItems: 'center', background: 'rgba(241, 243, 214, 0.13)', color: '#f1f3d6', fontWeight: 950 },
  z2QueueBody: { minWidth: 0, display: 'grid', gap: 2 },
  z2QueueScore: { color: '#fae7d2', fontWeight: 950, fontVariantNumeric: 'tabular-nums' },
  z2QueueEmpty: { color: '#e0d9c8', border: '1px dashed rgba(154, 144, 122, 0.26)', borderRadius: 8, padding: 12, fontSize: 13 },
  ...
  z2Metric_green: { borderColor: 'rgba(228, 239, 214, 0.24)', background: 'linear-gradient(135deg, rgba(127, 140, 18, 0.16), rgba(15,23,42,0.6))' },
  z2Metric_warning: { borderColor: 'rgba(250, 231, 210, 0.3)', background: 'linear-gradient(135deg, rgba(189, 112, 30, 0.16), rgba(15,23,42,0.6))' },
  z2Metric_danger: { borderColor: 'rgba(192, 73, 47, 0.32)', background: 'linear-gradient(135deg, rgba(192, 73, 47, 0.16), rgba(15,23,42,0.6))' },
  z2Metric_blue: { borderColor: 'rgba(241, 243, 214, 0.26)', background: 'linear-gradient(135deg, rgba(118, 100, 64, 0.16), rgba(15,23,42,0.6))' },
  ...
  decisionBand_warning: {
    ...
    background: 'linear-gradient(135deg, rgba(189, 112, 30, 0.12), var(--surface-glass))',
    boxShadow: 'inset 4px 0 0 var(--warning), var(--shadow-sm)',
  },
  decisionBand_danger: {
    border: '1px solid rgba(192, 73, 47, 0.32)',
    background: 'linear-gradient(135deg, rgba(192, 73, 47, 0.11), var(--surface-glass))',
  ...
  decisionPrimaryBtn: {
    ...
    fontWeight: 950,
    fontFamily: 'inherit',
    boxShadow: '0 10px 22px rgba(69, 107, 31, 0.18)',
  },
  ...
  quickCallPanel: {
    ...
    borderRadius: 8,
    background:
      'linear-gradient(135deg, rgba(127, 140, 18, 0.14), rgba(118, 100, 64, 0.08)), linear-gradient(180deg, rgba(255,255,255,0.94), rgba(239,248,243,0.82))',
    padding: 12,
    marginBottom: 12,
    boxShadow: '0 16px 40px rgba(69, 107, 31, 0.11)',
    scrollMarginTop: 18,
    position: 'relative',
    overflow: 'hidden',
  ...
  quickCallPanelFocused: {
    border: '1px solid var(--accent)',
    background: 'linear-gradient(135deg, rgba(127, 140, 18, 0.2), var(--glass-bg-strong))',
    boxShadow: '0 0 0 3px rgba(127, 140, 18, 0.18), var(--shadow-md)',
  },
  quickCallHeader: {
    display: 'flex',
    justifyContent: 'space-between',
  ...
  quickCallProgressMissing: {
    minHeight: 28,
    border: '1px solid rgba(153, 85, 16, 0.28)',
    borderRadius: 8,
  ...
  quickCallStepMissing: {
    border: '1px solid rgba(153, 85, 16, 0.26)',
  ...
  quickCallSchedulePanel_success: {
    border: '1px solid rgba(69, 107, 31, 0.24)',
    background: 'rgba(69, 107, 31, 0.06)',
  },
  quickCallSchedulePanel_warning: {
    border: '1px solid rgba(153, 85, 16, 0.3)',
  ...
  quickCallSchedulePanel_info: {
    border: '1px solid rgba(93, 106, 11, 0.24)',
    background: 'rgba(93, 106, 11, 0.06)',
  },
  ...
  workflowLanePanel: {
    ...
    borderRadius: 8,
    background: 'linear-gradient(135deg, rgba(69, 107, 31, 0.14), var(--glass-bg))',
    padding: 12,
    marginBottom: 12,
    boxShadow: 'var(--shadow-sm)',
  },
  ...
  workflowHealthItemWarn: {
    border: '1px solid rgba(250, 231, 210, 0.34)',
    background: 'rgba(189, 112, 30, 0.09)',
  },
  workflowHealthLabel: {
    color: 'var(--text-muted)',
    fontSize: 10,
  ...
  dailyOpsCard: {
    ...
    borderRadius: 8,
    background:
      'linear-gradient(145deg, rgba(255,255,255,0.98), rgba(237,248,242,0.9)), linear-gradient(90deg, rgba(69, 107, 31, 0.08), transparent)',
    color: 'var(--text)',
    ...
    gap: 5,
    textAlign: 'left',
    boxShadow: '0 14px 32px rgba(69, 107, 31, 0.09)',
    fontFamily: 'inherit',
    overflow: 'hidden',
    isolation: 'isolate',
  ...
  dailyOpsCardActive: {
    borderColor: 'rgba(69, 107, 31, 0.42)',
    boxShadow: '0 0 0 3px rgba(69, 107, 31, 0.12), var(--shadow-md)',
  ...
  dailyOpsAccent: {
    ...
    height: 36,
    borderRadius: 8,
    background: 'rgba(69, 107, 31, 0.07)',
  },
  dailyOpsLabel: {
    color: 'var(--text-muted)',
    fontSize: 10,
  ...
  opsCard: {
    minHeight: 92,
    border: '1px solid rgba(69, 107, 31, 0.15)',
    borderRadius: 8,
    ...
    justifyContent: 'space-between',
    gap: 5,
    boxShadow: '0 12px 28px rgba(69, 107, 31, 0.07)',
    transition: 'transform 180ms ease, border-color 180ms ease, box-shadow 180ms ease, background 180ms ease',
  },
  opsCard_green: { border: '1px solid rgba(228, 239, 214, 0.24)' },
  opsCard_blue: { border: '1px solid rgba(241, 243, 214, 0.24)' },
  opsCard_warning: { border: '1px solid rgba(250, 231, 210, 0.32)' },
  opsCard_danger: { border: '1px solid rgba(192, 73, 47, 0.34)' },
  opsCardLabel: {
    color: 'var(--text-muted)',
    fontSize: 10,
    fontWeight: 950,
  ...
  dispatchReadinessStrip: {
    border: '1px solid var(--glass-border)',
    borderRadius: 8,
    background: 'linear-gradient(135deg, rgba(69, 107, 31, 0.12), var(--glass-bg))',
    padding: '11px 12px',
    marginBottom: 12,
    display: 'grid',
    gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))',
  ...
  dispatchReadinessItemActive: {
    border: '1px solid var(--accent)',
    boxShadow: '0 0 0 2px rgba(69, 107, 31, 0.12)',
  },
  dispatchReadinessItemBlocked: {
    border: '1px solid rgba(250, 231, 210, 0.38)',
    backgroundColor: 'rgba(189, 112, 30, 0.1)',
  },
  ...
  businessRiskScore: {
    ...
    height: 30,
    borderRadius: 8,
    border: '1px solid rgba(192, 73, 47, 0.28)',
    background: 'rgba(192, 73, 47, 0.1)',
    color: '#c0492f',
    display: 'inline-flex',
    alignItems: 'center',
  ...
  closureRepairScore: {
    ...
    borderRadius: 8,
    border: '1px solid rgba(192, 73, 47, 0.28)',
    backgroundColor: 'rgba(192, 73, 47, 0.1)',
    color: '#c0492f',
    display: 'inline-flex',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  formWizardStepActive: {
    border: '1px solid rgba(69, 107, 31, 0.35)',
    backgroundColor: 'var(--accent-surface)',
    color: 'var(--text)',
  ...
  formRepairBanner: {
    ...
    borderRadius: 8,
    background: 'linear-gradient(135deg, rgba(189, 112, 30, 0.12), var(--surface-field))',
    padding: 12,
    display: 'grid',
  ...
  formRepairField: {
    ...
    background: 'rgba(189, 112, 30, 0.08)',
    padding: 8,
    boxShadow: 'inset 3px 0 0 rgba(189, 112, 30, 0.8)',
  },
  formRepairCard: {
    border: '1px solid rgba(189, 112, 30, 0.42)',
    boxShadow: 'inset 3px 0 0 rgba(189, 112, 30, 0.8), var(--shadow-sm)',
  },
  ...
  taskPhotosDraftBox: {
    border: '1px solid rgba(189, 112, 30, 0.28)',
    borderRadius: 8,
    backgroundColor: 'rgba(189, 112, 30, 0.08)',
    padding: 12,
    color: 'var(--text-sub)',
    display: 'flex',
    flexDirection: 'column',
  ...
  inputRepairFocus: { border: '1px solid rgba(189, 112, 30, 0.82)', boxShadow: '0 0 0 3px rgba(189, 112, 30, 0.16)' },
  inputDanger: { border: '1px solid var(--danger)', boxShadow: '0 0 0 3px rgba(192, 73, 47, 0.14)' },
  ...
  kanbanCard: {
    ...
    padding: 10,
    boxShadow: '0 10px 24px rgba(69, 107, 31, 0.07)',
  ...
  closeGuardItemDanger: {
    border: '1px solid rgba(192, 73, 47, 0.34)',
    backgroundColor: 'rgba(192, 73, 47, 0.1)',
  },
  closeGuardActions: {
    display: 'flex',
  ...
  detailGpsPanel: {
    border: '1px solid rgba(93, 106, 11, 0.18)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(93, 106, 11, 0.08), var(--glass-bg-strong))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  detailGpsMetric: {
    border: '1px solid rgba(93, 106, 11, 0.16)',
    borderRadius: 8,
  ...
  detailGpsRouteDot: {
    ...
    borderRadius: 999,
    background: '#5d6a0b',
    boxShadow: '0 0 0 3px rgba(93, 106, 11, 0.09)',
    flex: '0 0 auto',
  },
  detailGpsTimeline: {
    display: 'grid',
  ...
  detailGpsPointDot: {
    ...
    borderRadius: 999,
    background: '#5d6a0b',
    boxShadow: '0 0 0 3px rgba(93, 106, 11, 0.12)',
  },
  detailGpsPointTitle: {
    color: 'var(--text)',
    fontSize: 12,
  ...
  detailGpsPointLink: {
    ...
    borderRadius: 8,
    background: 'rgba(93, 106, 11, 0.08)',
    color: '#5d6a0b',
    padding: '6px 8px',
    fontSize: 11,
    fontWeight: 900,
  ...
  detailGpsEmpty: {
    border: '1px dashed rgba(93, 106, 11, 0.24)',
    borderRadius: 8,
  ...
  detailCommandLead: {
    ...
    color: '#fff',
    boxShadow: '0 12px 28px rgba(69, 107, 31, 0.16)',
  },
  detailCommandCard: {
    minHeight: 82,
    border: '1px solid rgba(69, 107, 31, 0.13)',
    borderLeft: '4px solid rgba(69, 107, 31, 0.26)',
    borderRadius: 8,
    background: '#ffffff',
    color: 'var(--text)',
    padding: '10px 12px',
  ...
  detailCommandCard_good: {
    ...
    background: 'linear-gradient(180deg, #ffffff, rgba(127, 140, 18, 0.07))',
  },
  detailCommandCard_blue: {
    borderLeftColor: '#5d6a0b',
    background: 'linear-gradient(180deg, #ffffff, rgba(93, 106, 11, 0.08))',
  },
  detailCommandCard_warning: {
    borderLeftColor: 'var(--warning)',
    background: 'linear-gradient(180deg, #ffffff, rgba(189, 112, 30, 0.09))',
  },
  detailCommandCard_danger: {
    borderLeftColor: 'var(--danger)',
    background: 'linear-gradient(180deg, #ffffff, rgba(192, 73, 47, 0.09))',
  },
  detailHeroPanel: {
    display: 'grid',
  ...
  detailHeroStat_good: {
    border: '1px solid rgba(69, 107, 31, 0.2)',
    backgroundColor: 'rgba(127, 140, 18, 0.08)',
  },
  detailHeroStat_blue: {
    border: '1px solid rgba(93, 106, 11, 0.18)',
    backgroundColor: 'rgba(93, 106, 11, 0.07)',
  },
  ...
  officeDecisionBoard: {
    ...
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.13), var(--glass-bg-strong))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  officeDecisionCard_warning: {
    border: '1px solid rgba(189, 112, 30, 0.34)',
    background: 'rgba(189, 112, 30, 0.09)',
  },
  officeDecisionCard_danger: {
    border: '1px solid rgba(192, 73, 47, 0.36)',
    background: 'rgba(192, 73, 47, 0.1)',
  },
  ...
  detailRepairPanel: {
    border: '1px solid rgba(189, 112, 30, 0.34)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(189, 112, 30, 0.11), var(--glass-bg-strong))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  detailRepairLead: {
    ...
    gap: 10,
    alignItems: 'center',
    border: '1px solid rgba(189, 112, 30, 0.3)',
    borderRadius: 8,
    background: 'rgba(255,255,255,0.72)',
    padding: 10,
    marginBottom: 10,
  ...
  officePlanningQueue: {
    ...
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.12), var(--surface-glass))',
    padding: 12,
    boxShadow: 'var(--shadow-md)',
  ...
  officeHandoffPanel: {
    border: '1px solid rgba(118, 100, 64, 0.28)',
    borderRadius: 10,
    background: 'linear-gradient(145deg, rgba(118, 100, 64, 0.1), var(--glass-bg-strong))',
    padding: '13px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  officeHandoffPanel_good: {
    border: '1px solid rgba(127, 140, 18, 0.34)',
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.11), var(--glass-bg-strong))',
  },
  officeHandoffPanel_warning: {
    border: '1px solid rgba(250, 231, 210, 0.38)',
    background: 'linear-gradient(145deg, rgba(250, 231, 210, 0.1), var(--glass-bg-strong))',
  },
  officeHandoffPanel_danger: {
    border: '1px solid rgba(192, 73, 47, 0.38)',
    background: 'linear-gradient(145deg, rgba(192, 73, 47, 0.1), var(--glass-bg-strong))',
  },
  officeHandoffHeader: {
    display: 'grid',
  ...
  officeHandoffCardOk: {
    border: '1px solid rgba(127, 140, 18, 0.26)',
    background: 'rgba(127, 140, 18, 0.08)',
  },
  officeHandoffCardWarn: {
    border: '1px solid rgba(250, 231, 210, 0.32)',
    background: 'rgba(250, 231, 210, 0.08)',
  },
  ...
  officePlanPanel: {
    border: '1px solid rgba(127, 140, 18, 0.34)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.12), var(--glass-bg))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  timeWindowHistory: {
    gridColumn: '1 / -1',
    borderTop: '1px solid rgba(93, 106, 11, 0.16)',
    paddingTop: 10,
    display: 'grid',
    gap: 7,
  },
  ...
  timeWindowStatus_danger: {
    border: '1px solid rgba(192, 73, 47, 0.26)',
    color: '#a3402a',
    background: 'rgba(192, 73, 47, 0.08)',
  },
  timeWindowMiniBtn: {
  ...
  officePlanConflictBox_warning: {
    border: '1px solid rgba(250, 231, 210, 0.38)',
    background: 'rgba(250, 231, 210, 0.1)',
  },
  ...
  officePlanMissingRepairBadge: {
    ...
    borderRadius: 7,
    border: '1px solid rgba(250, 231, 210, 0.38)',
    background: 'rgba(250, 231, 210, 0.12)',
    color: '#995510',
    fontSize: 10,
    fontWeight: 900,
  },
  ...
  detailOwnerPanel: {
    border: '1px solid rgba(127, 140, 18, 0.3)',
    borderRadius: 8,
    background: 'linear-gradient(135deg, rgba(127, 140, 18, 0.12), var(--glass-bg-strong))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
    display: 'grid',
  ...
  detailOwnerPanel_active: {
    border: '1px solid rgba(118, 100, 64, 0.38)',
    background: 'linear-gradient(135deg, rgba(118, 100, 64, 0.12), var(--glass-bg-strong))',
  },
  ...
  detailOwnerPanel_warning: {
    border: '1px solid rgba(250, 231, 210, 0.38)',
    background: 'linear-gradient(135deg, rgba(250, 231, 210, 0.12), var(--glass-bg-strong))',
  },
  detailOwnerPanel_danger: {
    border: '1px solid rgba(192, 73, 47, 0.4)',
    background: 'linear-gradient(135deg, rgba(192, 73, 47, 0.13), var(--glass-bg-strong))',
  },
  detailOwnerMain: {
    minWidth: 0,
    display: 'flex',
  ...
  workflowPathPanel: {
    border: '1px solid rgba(118, 100, 64, 0.28)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(118, 100, 64, 0.1), var(--glass-bg))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  workflowPathPanelFocused: {
    border: '1px solid rgba(160, 175, 20, 0.72)',
    boxShadow: '0 0 0 3px rgba(160, 175, 20, 0.18), var(--shadow-md)',
  },
  workflowPathHeader: {
    display: 'flex',
    justifyContent: 'space-between',
  ...
  workflowPathStepActive: {
    border: '1px solid rgba(118, 100, 64, 0.42)',
    backgroundColor: 'rgba(118, 100, 64, 0.12)',
    color: 'var(--text)',
  },
  ...
  workflowPathBtnBlocked: {
    border: '1px solid rgba(192, 73, 47, 0.32)',
    backgroundColor: 'rgba(192, 73, 47, 0.08)',
    color: 'var(--danger)',
  },
  ...
  detailWorkflowPanel: {
    border: '1px solid rgba(127, 140, 18, 0.3)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.1), var(--glass-bg-strong))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  detailWorkflowStep_done: {
    border: '1px solid rgba(127, 140, 18, 0.34)',
    backgroundColor: 'rgba(127, 140, 18, 0.09)',
  },
  detailWorkflowStep_active: {
    border: '1px solid rgba(118, 100, 64, 0.44)',
    backgroundColor: 'rgba(118, 100, 64, 0.12)',
  },
  detailWorkflowStep_ready: {
    border: '1px solid rgba(160, 175, 20, 0.32)',
    backgroundColor: 'rgba(160, 175, 20, 0.08)',
  },
  detailWorkflowStep_warning: {
    border: '1px solid rgba(189, 112, 30, 0.2)',
    backgroundColor: 'rgba(189, 112, 30, 0.1)',
  },
  ...
  detailWorkflowOptionalPill: {
    ...
    borderRadius: 8,
    backgroundColor: 'rgba(250, 231, 210, 0.1)',
    color: 'var(--warning)',
    padding: '4px 6px',
    fontSize: 10,
    fontWeight: 900,
  ...
  crewBriefPanel: {
    border: '1px solid rgba(127, 140, 18, 0.32)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(69, 107, 31, 0.18), var(--glass-bg))',
    padding: '12px 14px',
    marginBottom: 12,
    boxShadow: 'var(--shadow-md)',
  },
  ...
  crewPackageSummary: {
    border: '1px solid rgba(127, 140, 18, 0.18)',
    borderRadius: 8,
  ...
  detailPriceBox_warning: {
    border: '1px solid rgba(189, 112, 30, 0.32)',
    backgroundColor: 'rgba(189, 112, 30, 0.09)',
  },
  ...
  listTaskCard: {
    position: 'relative',
    background:
      'linear-gradient(145deg, rgba(255,255,255,0.98), rgba(240,248,244,0.9)), linear-gradient(90deg, rgba(69, 107, 31, 0.08), transparent 42%)',
    border: '1px solid rgba(69, 107, 31, 0.16)',
    borderLeft: '5px solid var(--accent)',
    borderRadius: 8,
    boxShadow: '0 18px 42px rgba(69, 107, 31, 0.1)',
    padding: 14,
    display: 'flex',
    flexDirection: 'column',
    gap: 8,
  ...
  contactMiniDanger: {
    color: 'var(--danger)',
    border: '1px solid rgba(192, 73, 47, 0.32)',
    backgroundColor: 'rgba(192, 73, 47, 0.09)',
  },
  contactDot: {
    width: 7,
    height: 7,
  ...
  contactDot_good: {
    ...
    boxShadow: '0 0 8px rgba(127, 140, 18, 0.45)',
  },
  contactDot_warning: {
    backgroundColor: 'var(--supernova-orange)',
    boxShadow: '0 0 8px rgba(189, 112, 30, 0.42)',
  },
  contactDot_danger: {
  ...
  workflowStage_blue: {
    border: '1px solid rgba(241, 243, 214, 0.3)',
    backgroundColor: 'rgba(241, 243, 214, 0.08)',
  },
  ...
  stageOwnerMini: {
    border: '1px solid rgba(127, 140, 18, 0.26)',
    borderRadius: 8,
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.09), rgba(255,255,255,0.82))',
    padding: '9px 10px',
    display: 'grid',
    gap: 6,
    minWidth: 0,
  ...
  stageOwnerMini_good: {
    border: '1px solid rgba(127, 140, 18, 0.3)',
    background: 'linear-gradient(145deg, rgba(127, 140, 18, 0.1), rgba(255,255,255,0.82))',
  },
  stageOwnerMini_warning: {
    border: '1px solid rgba(250, 231, 210, 0.34)',
    background: 'linear-gradient(145deg, rgba(250, 231, 210, 0.11), rgba(255,255,255,0.82))',
  },
  stageOwnerMini_danger: {
    border: '1px solid rgba(192, 73, 47, 0.34)',
    background: 'linear-gradient(145deg, rgba(192, 73, 47, 0.1), rgba(255,255,255,0.82))',
  },
  stageOwnerMini_blue: {
    border: '1px solid rgba(241, 243, 214, 0.32)',
    background: 'linear-gradient(145deg, rgba(241, 243, 214, 0.1), rgba(255,255,255,0.82))',
  },
  ...
  fieldExecutionRow_warning: {
    borderColor: 'rgba(189, 112, 30, 0.34)',
    backgroundColor: 'rgba(189, 112, 30, 0.1)',
  },
  fieldExecutionRow_danger: {
    borderColor: 'rgba(192, 73, 47, 0.36)',
    backgroundColor: 'rgba(192, 73, 47, 0.1)',
  },
  fieldExecutionRow_muted: {
    borderColor: 'rgba(154, 144, 122, 0.18)',
    backgroundColor: 'rgba(154, 144, 122, 0.08)',
  },
  fieldExecutionMain: {
    display: 'grid',
    gap: 2,
  ...
  readinessTrack: {
    ...
    borderRadius: 8,
    overflow: 'hidden',
    backgroundColor: 'rgba(154, 144, 122, 0.18)',
  },
  readinessFill: {
    display: 'block',
    height: '100%',
  ...
  blockerDanger: {
    backgroundColor: 'rgba(192, 73, 47, 0.14)',
    border: '1px solid rgba(192, 73, 47, 0.28)',
    color: '#c0492f',
  },
  blockerWarning: {
    backgroundColor: 'rgba(189, 112, 30, 0.15)',
    border: '1px solid rgba(189, 112, 30, 0.3)',
    color: '#995510',
  },
  blockerGood: {
