...
const s = {
  ...
  z2Primary: {
    ...
    borderRadius: 8,
    background: 'linear-gradient(135deg, rgba(44, 32, 17,0.72), rgba(42, 29, 15,0.78))',
  },
  ...
  z2Queue: {
    ...
    border: '1px solid rgba(154, 144, 122, 0.18)',
    borderRadius: 8,
    background: 'linear-gradient(180deg, rgba(44, 32, 17,0.82), rgba(42, 29, 15,0.72))',
    display: 'grid',
    alignContent: 'start',
    gap: 12,
  },
  ...
  z2Metric_green: { borderColor: 'rgba(228, 239, 214, 0.24)', background: 'linear-gradient(135deg, rgba(127, 140, 18, 0.16), rgba(44, 32, 17,0.6))' },
