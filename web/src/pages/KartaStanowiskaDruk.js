...
const S = {
  ...
  header: {
    ...
    gap: 20,
    alignItems: 'start',
    borderBottom: '2px solid #2c2011',
    paddingBottom: 18,
    marginBottom: 18,
  },
  brand: { color: '#456b1f', fontSize: 12, fontWeight: 950, letterSpacing: 0, textTransform: 'uppercase' },
  title: { margin: '4px 0 8px', color: '#2c2011', fontSize: 30, lineHeight: 1.1, fontWeight: 950 },
  subtitle: { margin: 0, color: '#5a5040', fontSize: 14, lineHeight: 1.45, fontWeight: 700 },
  statusBox: {
    border: '1px solid #e0d9c8',
    borderRadius: 8,
    background: '#f0ebdd',
  ...
  statusLabel: { display: 'block', color: '#5a5040', fontSize: 11, fontWeight: 900, textTransform: 'uppercase' },
  statusValue: { display: 'block', color: '#456b1f', fontSize: 16, fontWeight: 950, marginTop: 4 },
  statusMeta: { display: 'block', color: '#5a5040', fontSize: 12, fontWeight: 700, marginTop: 8 },
  detailsGrid: {
    display: 'grid',
  ...
  detailLabel: { display: 'block', color: '#5a5040', fontSize: 10, fontWeight: 900, textTransform: 'uppercase' },
  detailValue: { display: 'block', color: '#2c2011', fontSize: 13, lineHeight: 1.35, fontWeight: 900, marginTop: 4 },
  section: {
    borderTop: '1px solid #e0d9c8',
    paddingTop: 14,
    marginTop: 14,
  },
  sectionTitle: { margin: '0 0 10px', color: '#2c2011', fontSize: 16, lineHeight: 1.25, fontWeight: 950 },
  list: { margin: 0, paddingLeft: 20, color: '#2c2011', fontSize: 13, lineHeight: 1.5, fontWeight: 650 },
  ...
  note: { margin: '8px 0 0', color: '#2c2011', fontSize: 13, lineHeight: 1.45, fontWeight: 650 },
  statement: { margin: 0, color: '#2c2011', fontSize: 13, lineHeight: 1.55, fontWeight: 700 },
