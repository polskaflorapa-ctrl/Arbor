...
const ui = {
  ...
  layout: { display: 'grid', gridTemplateColumns: 'minmax(260px, 360px) minmax(0, 1fr)', gap: 18, alignItems: 'start' },
  sideColumn: { display: 'grid', gap: 14 },
  contentColumn: { display: 'grid', gap: 14, minWidth: 0 },
  panel: { display: 'grid', gap: 12, background: '#fff', border: '1px solid #f0ebdd', borderRadius: 12, padding: 18, boxShadow: '0 8px 24px rgba(44, 32, 17, 0.04)' },
  ...
  issueGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(150px, 100%), 1fr))', gap: 10, alignItems: 'center', minWidth: 0 },
  ...
  itemCard: { background: '#fff', border: '1px solid #f0ebdd', borderRadius: 12, padding: 18, boxShadow: '0 8px 24px rgba(44, 32, 17, 0.04)' },
