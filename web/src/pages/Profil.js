...
export default function Profil() {
  ...
  const S = {
    ...
    okBadge: { color: 'var(--accent-text)', border: '1px solid rgba(127, 140, 18, 0.35)', background: 'rgba(127, 140, 18, 0.09)' },
    warnBadge: { color: '#9a5613', border: '1px solid rgba(189, 112, 30, 0.35)', background: 'rgba(189, 112, 30, 0.09)' },
    ...
    statValue: { color: 'var(--accent-text)', fontSize: 22, fontWeight: 950, lineHeight: 1.1 },
    ...
    quickDueBtn: {
      ...
      fontFamily: 'inherit',
      whiteSpace: 'nowrap',
      boxShadow: 'inset 0 0 0 1px rgba(69, 107, 31, 0.06)',
    },
    ...
    todoOverdue: { border: '1px solid rgba(189, 112, 30, 0.35)', background: 'rgba(189, 112, 30, 0.08)' },
    ...
    permissionOn: { border: '1px solid rgba(127, 140, 18, 0.28)' },
    ...
    progressFill: {
      height: '100%',
      borderRadius: 8,
      background: 'linear-gradient(90deg, #7f8c12, var(--accent))',
    },
    ...
    markOk: { color: 'var(--accent-text)', background: 'rgba(127, 140, 18, 0.12)', border: '1px solid rgba(127, 140, 18, 0.3)' },
    markWarn: { color: '#9a5613', background: 'rgba(189, 112, 30, 0.1)', border: '1px solid rgba(189, 112, 30, 0.28)' },
    ...
    dot: {
      ...
      marginTop: 4,
      background: '#7f8c12',
      boxShadow: '0 0 0 3px rgba(127, 140, 18, 0.12)',
    },
    confirmBtn: {
      width: '100%',
      minHeight: 42,
      border: '1px solid var(--border)',
      borderRadius: 8,
      background: documentConfirmed ? 'rgba(127, 140, 18, 0.12)' : 'var(--accent-surface)',
      color: documentConfirmed ? '#5d6a0b' : 'var(--accent-text)',
      cursor: 'pointer',
      fontSize: 13,
      fontWeight: 900,
      fontFamily: 'inherit',
    ...
    documentOk: { border: '1px solid rgba(127, 140, 18, 0.25)' },
    documentWarn: { border: '1px solid rgba(189, 112, 30, 0.35)', background: 'rgba(189, 112, 30, 0.08)' },
    documentDanger: { border: '1px solid rgba(192, 73, 47, 0.35)', background: 'rgba(192, 73, 47, 0.08)' },
