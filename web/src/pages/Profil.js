...
export default function Profil() {
  ...
  const S = {
    ...
    okBadge: { color: '#7f8c12', border: '1px solid rgba(127, 140, 18, 0.35)', background: 'rgba(127, 140, 18, 0.09)' },
    warnBadge: { color: '#bd701e', border: '1px solid rgba(189, 112, 30, 0.35)', background: 'rgba(189, 112, 30, 0.09)' },
    ...
    markOk: { color: '#7f8c12', background: 'rgba(127, 140, 18, 0.12)', border: '1px solid rgba(127, 140, 18, 0.3)' },
    markWarn: { color: '#bd701e', background: 'rgba(189, 112, 30, 0.1)', border: '1px solid rgba(189, 112, 30, 0.28)' },
    ...
    confirmBtn: {
      ...
      color: documentConfirmed ? '#7f8c12' : 'var(--accent)',
      cursor: 'pointer',
      fontSize: 13,
      fontWeight: 900,
      fontFamily: 'inherit',
