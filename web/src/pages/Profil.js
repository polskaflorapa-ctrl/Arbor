...
export default function Profil() {
  ...
  const S = {
    ...
    okBadge: { color: '#7f8c12', border: '1px solid rgba(52,211,153,0.35)', background: 'rgba(52,211,153,0.09)' },
    warnBadge: { color: '#bd701e', border: '1px solid rgba(249,168,37,0.35)', background: 'rgba(249,168,37,0.09)' },
    ...
    markOk: { color: '#7f8c12', background: 'rgba(52,211,153,0.12)', border: '1px solid rgba(52,211,153,0.3)' },
    markWarn: { color: '#bd701e', background: 'rgba(249,168,37,0.1)', border: '1px solid rgba(249,168,37,0.28)' },
