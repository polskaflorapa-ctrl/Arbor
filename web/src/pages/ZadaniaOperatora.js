...
const S = {
  ...
  statValue: { color: 'var(--accent-text)', fontSize: 24, fontWeight: 950, lineHeight: 1.1 },
  ...
  trOverdue: { background: 'rgba(192, 73, 47, 0.06)' },
  ...
  badgeOk: { color: 'var(--accent-text)', borderColor: 'rgba(127, 140, 18, 0.35)', background: 'rgba(127, 140, 18, 0.09)' },
  badgeInfo: { color: '#f1f3d6', borderColor: 'rgba(241, 243, 214, 0.35)', background: 'rgba(241, 243, 214, 0.09)' },
  badgeWarn: { color: '#9a5613', borderColor: 'rgba(189, 112, 30, 0.35)', background: 'rgba(189, 112, 30, 0.09)' },
  ...
  dueToday: { color: '#9a5613' },
  dueOverdue: { color: '#c0492f' },
