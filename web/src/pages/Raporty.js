...
const styles = {
  ...
  statusBar: { width: 120, height: 8, backgroundColor: 'var(--surface-field)', borderRadius: 4, overflow: 'hidden' },
  ...
  reportMetaLabel: { fontSize: 11, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 0, fontWeight: 700 },
  ...
  analyticsScroll: { marginTop: 10, overflowX: 'auto', border: '1px solid var(--border)', borderRadius: 8 },
  analyticsTable: { width: '100%', borderCollapse: 'collapse', minWidth: 1450, backgroundColor: 'var(--surface-glass)' },
  analyticsTh: { padding: '10px 10px', backgroundColor: 'var(--surface-field)', color: 'var(--text-muted)', fontSize: 12, fontWeight: 700, whiteSpace: 'nowrap', borderBottom: '1px solid var(--border)' },
  analyticsThSticky: { position: 'sticky', left: 0, zIndex: 3, padding: '10px 12px', backgroundColor: 'var(--surface-field)', color: 'var(--text)', fontSize: 12, fontWeight: 800, whiteSpace: 'nowrap', borderBottom: '1px solid var(--border)' },
  analyticsThDay: { padding: '10px 8px', backgroundColor: 'var(--surface-field)', color: 'var(--text-muted)', fontSize: 11, fontWeight: 700, whiteSpace: 'nowrap', borderBottom: '1px solid var(--border)', textAlign: 'center' },
  analyticsTd: { padding: '8px 10px', color: 'var(--text-sub)', fontSize: 12, borderBottom: '1px solid var(--border)', whiteSpace: 'nowrap' },
  analyticsTdSticky: { position: 'sticky', left: 0, zIndex: 2, padding: '8px 12px', color: 'var(--text)', backgroundColor: 'var(--surface-glass)', fontSize: 12, fontWeight: 700, borderBottom: '1px solid var(--border)', whiteSpace: 'nowrap' },
