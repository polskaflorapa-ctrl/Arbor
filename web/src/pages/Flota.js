        ...
        <div style={S.assetDetailSection}>
          ...
          <div style={S.assetDocList}>
            {detail.documents.length ? detail.documents.map((doc) => (
              <div key={doc.id} style={{ ...S.assetDocRow, borderColor: dateHealth(doc.wazny_do).state === 'expired' ? 'rgba(192, 73, 47, 0.45)' : dateHealth(doc.wazny_do).state === 'soon' ? 'rgba(189, 112, 30, 0.45)' : 'var(--border)' }}>
...
const S = {
  ...
  repairCloseBtn: { marginTop: 4, width: '100%', padding: '8px 10px', borderRadius: 8, border: '1px solid rgba(69, 107, 31, 0.28)', background: 'var(--accent-gradient)', color: 'var(--on-accent)', cursor: 'pointer', fontSize: 12, fontWeight: 900 },
  ...
  maintenancePrimaryBtn: { padding: '8px 11px', borderRadius: 8, borderWidth: 1, borderStyle: 'solid', borderColor: 'rgba(69, 107, 31, 0.28)', backgroundColor: 'var(--accent)', backgroundImage: 'var(--accent-gradient)', color: 'var(--on-accent)', cursor: 'pointer', fontSize: 12, fontWeight: 900 },
  ...
  maintenanceTopItem: { display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', textAlign: 'left', borderWidth: 1, borderStyle: 'solid', borderColor: 'rgba(192, 73, 47, 0.24)', borderRadius: 8, backgroundColor: 'rgba(192, 73, 47, 0.06)', backgroundImage: 'none', color: 'var(--text)', padding: '8px 10px', cursor: 'pointer', fontSize: 12, fontWeight: 800 },
  ...
  assetTimelineDot: { width: 9, height: 9, borderRadius: 999, background: 'var(--accent)', marginTop: 5, boxShadow: '0 0 0 4px rgba(69, 107, 31, 0.12)' },
  ...
  reservationWarning: { border: '1px solid rgba(192, 73, 47, 0.35)', borderRadius: 8, background: 'rgba(192, 73, 47, 0.08)', color: 'var(--danger)', padding: 9, fontSize: 12, fontWeight: 900, marginBottom: 8 },
  ...
  protocolSummary: { gridColumn: '1 / -1', display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(140px, auto) auto', gap: 8, alignItems: 'center', border: '1px solid rgba(69, 107, 31, 0.18)', borderRadius: 8, background: 'rgba(69, 107, 31, 0.06)', color: 'var(--text-sub)', padding: '7px 9px', fontSize: 12, minWidth: 0 },
