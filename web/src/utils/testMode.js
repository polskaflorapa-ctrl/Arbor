...
export const MOCK_DATA = {
  zlecenia: [
    ...
    {
      id: 1,
      klient_nazwa: 'Dom pod Lasem',
      klient_telefon: '+48500444111',
      adres: 'ul. Sosnowa 14',
      miasto: 'Myslenice',
      typ_uslugi: 'Mycie / malowanie dachów',
      status: 'Zaplanowane',
      ...
      opis: 'Mycie dachu i ocena powloki przed malowaniem.',
    },
    {
      id: 2,
      klient_nazwa: 'Kamienica Nadwislanska',
      klient_telefon: '+48500444222',
      adres: 'ul. Nadwislanska 19',
      miasto: 'Kraków',
      typ_uslugi: 'Czyszczenie kostki / elewacji',
      status: 'W realizacji',
      ...
      ekipa_nazwa: 'Ekipa A',
      oddzial_id: 2,
      wartosc_planowana: 3600,
      opis: 'Czyszczenie kostki na podjezdzie i elewacji frontowej.',
    },
    {
      id: 104,
      ...
      adres: 'ul. Lipowa 8',
      miasto: 'Krakow',
      typ_uslugi: 'Projekt i pielegnacja ogrodu',
      status: 'Wycena_Terenowa',
      priorytet: 'Normalny',
      data_planowana: new Date(Date.now() + 2 * 86400000).toISOString().slice(0, 10),
      wyceniajacy_id: 9004,
      wyceniajacy_nazwa: 'Test Specjalista Wyceny',
      ekipa_id: '',
      wartosc_planowana: 0,
      czas_planowany_godziny: '',
      opis_pracy: 'Oględziny ogrodu, zakres nasadzeń i pielęgnacji sezonowej.',
      oddzial_id: 1,
      photo_total: 1,
      photo_wycena: 1,
      photo_szkic: 0,
...
function mockCrmInboxMessages() {
  ...
  return [
    ...
    },
    {
      ...
      channel: 'email',
      direction: 'outbound',
      sender_name: 'Polska Flora',
      sender_handle: 'oferty@arbor.local',
      recipient_handle: 'zarzad.zielona@example.test',
      subject: 'Oferta Polska Flora - Zielona 12',
      body: 'Dzień dobry, oferta jest gotowa. W załączniku zakres prac i termin realizacji.',
      status: 'queued',
    ...
    },
    {
      ...
      direction: 'outbound',
      sender_name: 'Polska Flora',
      sender_handle: 'Polska Flora',
      recipient_handle: '+48500666555',
      subject: null,
      body: 'Dzień dobry, potwierdzamy przyjęcie zgłoszenia i oddzwonimy w sprawie terminu.',
      status: 'failed',
      external_thread_id: 'mock-crm-thread-9301',
      retry_count: 2,
    ...
    return [
      {
        ...
        id: 9101,
        direction: 'inbound',
        body: 'Dzień dobry, proszę o szybką wycenę przycięcia drzew przy ogrodzeniu.',
      ...
      },
      {
        ...
        body: 'Dzień dobry, możemy podjechać jutro rano. Czy pasuje 9:30?',
        status: 'sent',
  ...
  return [
    {
      ...
      channel: 'whatsapp',
      subject: null,
      body: 'Dzień dobry, wracam z informacją po oględzinach. Przygotujemy wycenę i proponowany termin.',
      active: true,
    },
    {
      id: 932,
      ...
      channel: 'sms',
      subject: null,
      body: 'Dzień dobry, dziękujemy za zgłoszenie. Oddzwonimy z terminem oględzin.',
      active: true,
    },
  ];
}

function mockCrmToday() {
  const messages = mockCrmInboxMessages();
  const inbound = messages.filter((message) => message.direction === 'inbound' && ['received', 'failed'].includes(message.status));
  const failed = messages.filter((message) => message.direction === 'outbound' && message.status === 'failed');
  const unassigned = [
    {
      id: 9301,
      title: 'Dom Seniora Parkowy - awaria SMS',
      stage: 'Lead',
      source: 'telegram',
      value: 3200,
      phone: '+48500666555',
      email: 'parkowy@example.test',
      client_name: 'Dom Seniora Parkowy',
      owner_user_id: null,
      owner_name: null,
      oddzial_id: 1,
  ...
  const stale = [
    {
      id: 9201,
      title: 'Wspolnota Zielona 12 - oferta po ogledzinach',
      stage: 'Do zatwierdzenia',
      source: 'email',
      value: 8600,
      phone: '+48500777888',
      email: 'zarzad.zielona@example.test',
      client_name: 'Wspolnota Zielona 12',
      owner_user_id: 9001,
      owner_name: 'Test Dyrektor',
      oddzial_id: 1,
    ...
    overdue_followups: [
      {
        id: 7701,
        lead_id: 9201,
        text: 'Oddzwon do zarzadu wspolnoty po decyzje w sprawie terminu.',
